...
class Ui_RegisterWindow(object):
    ...
    def retranslateUi(self, RegisterWindow):
        ...
        self.comboBoxSecurityQuestion.setItemText(0, _translate("RegisterWindow", "What is the name of your pet?"))
        self.comboBoxSecurityQuestion.setItemText(1, _translate("RegisterWindow", "What is your mom\'s name?"))
        self.comboBoxSecurityQuestion.setItemText(2, _translate("RegisterWindow", "In what town do you live?"))
        self.comboBoxSecurityQuestion.setItemText(3, _translate("RegisterWindow", "What school do you attend?"))
        self.comboBoxSecurityQuestion.setItemText(4, _translate("RegisterWindow", "Which is your favorite food?"))
        ...
        self.label_8.setText(_translate("RegisterWindow", "<html><head/><body><p><span style=\" font-size:16pt;\">Security question :</span></p></body></html>"))
